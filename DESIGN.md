...
The reasoning behind `statement-normalizer`, split out of the README so the
README can be read in a minute. Nothing here is needed to run the project — this
is the *why* behind each decision that was not obvious, and the record of what
real bank exports forced that no invented fixture would have.

Start at [README.md](README.md) for what it is and how to run it.

---

## Identity: the same transaction arriving twice
...
### What the upload response returns, and why it is an envelope
